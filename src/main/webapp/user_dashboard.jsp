        ...
        <div class="main__container">
          ...
          <!-- CHARTS STARTS HERE -->
            ...
            <div class="charts__left">
              ...
              <form action="fetch_bus_list.jsp" method="post">
              <div class="charts__left__cards">
                <div class="card1">
                  <h1> Source</h1>
                  <p class="go"><input type="text" class="label" name="source" required></p>
                </div>

                <div class="card2">
                  <h1>Destination</h1>
                  <p class="go"><input type="text" class="label" name="destination" required></p>
                </div>
                  <h1><input type="submit" value="Go"></h1>
			</div>
			</form>
            </div>
      ...
      <div id="sidebar">
        ...
        <div class="sidebar__menu">
          ...
          <div class="sidebar__link">
            ...
            <a href="index.jsp">Go bus Services</a>
          </div>
