    ...
    <div class="container">
      ...
      <main>
        <div class="main__container">
          ...
          <form action="add_passservlet" method="Post">
          				
          			<input type="hidden" name="busid" value="${param.busid }">
					<input type="hidden" name="source" value="${param.source }">
					<input type="hidden" name="destination" value="${param.destination }">
					<input type="hidden" name="busdate" value="${param.busdate }">
					<input type="hidden" name="dtiming" value="${param.dtiming }">
					<input type="hidden" name="busfare" value="${param.busfare }">
					<input type="hidden" name="seat" value="${param.seat }">
					<input type="hidden" name="seatleft" value="${param.seatleft }">
					
          			<c:forEach var = "i" begin = "1" end = "${param.seat }">
          			
         		          <p class="text-primary-p">Enter Passenger Name</p>
                          <span class="font-bold text-title"><input type="text" name="name" required></span><br>
                          
                          <p class="text-primary-p">Enter Passenger Age</p>
                          <span class="font-bold text-title"><input type="text" name="age" required></span> <br>   
                          
                     </c:forEach>  
                     
                      <span class="font-bold text-title"><input type="submit" value="ADD"></span>                    
