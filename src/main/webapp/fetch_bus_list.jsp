      ...
      <main>
        <div class="main__container">
          ...
          <!-- CHARTS STARTS HERE -->
           ...
           <sql:query var="rs" dataSource="${db}">select * from bus_detail where source="${param.source }" and destination="${param.destination }"</sql:query>
...
<td><a href="booking.jsp?busid=${blist.busid}">Book Now</a></td> 
