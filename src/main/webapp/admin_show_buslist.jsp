...
<html lang="en">
  <head>
    ...
    <title>Admin Show Buslist</title>
    ...
    <div class="container">
      ...
      <main>
        <div class="main__container">
          ...
          <sql:query var="rs" dataSource="${db}">select * from bus_detail</sql:query>
...
<td><c:out value="${blist.busname}"/></td>   
<td><c:out value="${blist.source}"/></td>  
<td><c:out value="${blist.destination}"/></td>  
<td><c:out value="${blist.bustype}"/></td>  
<td><c:out value="${blist.atiming}"/></td>  
<td><c:out value="${blist.dtiming}"/></td>  
<td><c:out value="${blist.busdate}"/></td>  
<td><c:out value="${blist.duration}"/></td> 
<td><c:out value="${blist.busfare}"/></td> 
<td><c:out value="${blist.totalseat}"/></td> 
<td><c:out value="${blist.seatleft}"/></td> 
<td><a href="admin_edit_busdetails.jsp?busid=${blist.busid}">EDIT BUS LIST</a></td>
<td><a href="admin_delete_bus.jsp?busid=${blist.busid}">DELETE BUS LIST</a></td> 
</tr>  
