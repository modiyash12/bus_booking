...
<body>
  ...
  <div class="card login-form">
    <div class="card-body">
      ...
      <h2 class="card-title text-center"><b><u>Forgot Password</u></b></h2>
      <form action="forgot_pass_servlet" method="post">
      <!--Password must contain one lowercase letter, one number, and be at least 7 characters long.-->
          ...
          <div class="form-group">
            ...
            <input type="text"   name="securityquestion" class="form-control form-control-sm" placeholder="Security Question">
          </div>
          <div class="form-group">
         
            <input type="text" name="answer"  class="form-control form-control-sm" placeholder="Answer">
          </div>
          <span>${error }</span>
